...
#default['7-zip']['url']            = "http://downloads.sourceforge.net/project/sevenzip/7-Zip/9.20/7z920.msi?r=&ts=1336850059&use_mirror=heanet"
#  default['7-zip']['checksum']     = "fe4807b4698ec89f82de7d85d32deaa4c772fc871537e31fb0fccf4473455cb8"
  default['7-zip']['package_name'] = "7-Zip 9.20"
end

default['7-zip']['home']    = "#{ENV['ProgramFiles']}\\7-zip"
